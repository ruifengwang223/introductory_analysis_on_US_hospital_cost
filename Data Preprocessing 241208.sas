*/Import 2017-2022 csv data files for data exploration./;
PROC IMPORT 
		DATAFILE="/home/u64000221/Hospital Cost Project/Data Sets/CostReport_2017_Final.csv"
		DBMS=CSV
		REPLACE
		OUT=data2017;
RUN;
...
PROC IMPORT 
		DATAFILE="/home/u64000221/Hospital Cost Project/Data Sets/CostReport_2018_Final.csv"
		DBMS=CSV
		REPLACE
		OUT=data2018;
RUN;
...
PROC IMPORT 
		DATAFILE="/home/u64000221/Hospital Cost Project/Data Sets/CostReport_2019_Final.csv"
		DBMS=CSV
		REPLACE
		OUT=data2019;
RUN;
...
PROC IMPORT 
		DATAFILE="/home/u64000221/Hospital Cost Project/Data Sets/CostReport_2020_Final.csv"
		DBMS=CSV
		REPLACE
		OUT=data2020;
RUN;
...
PROC IMPORT 
		DATAFILE="/home/u64000221/Hospital Cost Project/Data Sets/CostReport_2021_Final.csv"
		DBMS=CSV
		REPLACE
		OUT=data2021;
RUN;
...
PROC IMPORT 
		DATAFILE="/home/u64000221/Hospital Cost Project/Data Sets/CostReport_2022_Final.csv"
		DBMS=CSV
		REPLACE
		OUT=data2022;
RUN;

*/Create Permanent library to store the dataset./;
*/Assign the year to the dataset./;
